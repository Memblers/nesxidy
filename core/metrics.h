...
#define metrics_bfs_start()               do{}while(0)
#define metrics_bfs_visit_address()       do{}while(0)
#define metrics_bfs_entry_point()         do{}while(0)
#define metrics_bfs_end()                 do{}while(0)
#define metrics_compile_start()           do{}while(0)
#define metrics_block_compiled(len)       do{}while(0)
#define metrics_block_failed()            do{}while(0)
#define metrics_block_skipped()           do{}while(0)
#define metrics_bitmap_entry()            do{}while(0)
#define metrics_compile_end()             do{}while(0)
#define metrics_optimizer_run(m,p)        do{}while(0)
#define metrics_peephole_remove(p,l)      do{}while(0)
#define metrics_ir_block(b,a)              do{}while(0)
#define metrics_ir_pass_results(rl,ds,dl,pp,pr,rmw)  do{}while(0)
#define metrics_ir_nodes_killed(n)         do{}while(0)
#define metrics_ir_instrs_eliminated(n)    do{}while(0)
#define metrics_ir_instr_overflow()        do{}while(0)
