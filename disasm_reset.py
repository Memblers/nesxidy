...
# Check RESET continuation to see $25 init
print('=== RESET handler $C08D-$C0D0 ===')
disasm(0xC08D, 0x50)

# Check $C214 (called by NMI handler)
print()
print('=== $C214 (JSR target from NMI) ===')
disasm(0xC214, 0x28)

# Also check what lnPPUCTRL ($22) is before our main() runs
print()
print('=== RESET $C042-$C08D ===')
disasm(0xC042, 0x4B)
